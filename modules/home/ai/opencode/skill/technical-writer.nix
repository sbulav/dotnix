{
  ...
  version = "1.0.0";
  description = "Creates clear documentation, API references, guides, and technical content for developers and users. Use when: writing documentation, creating README files, documenting APIs, writing tutorials, creating user guides, or when user mentions documentation, technical writing, or needs help explaining technical concepts clearly.";
  allowed-tools = [
    "Read"
    "Write"
    "Edit"
...
### No files shown
Check if you are filtering too aggressively:
\`\`\`bash
