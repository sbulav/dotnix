...
in
{
  ...
  # Keep the server recoverable from a full userspace/kernel lockup. The
  # motherboard exposes an AMD SP5100 TCO hardware watchdog.
  ...
  services.nix-remote-builder.server.enable = false;
